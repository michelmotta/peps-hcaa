...
class FileSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $files = [
            ...
            [
                'name' => 'pdf_sample.pdf',
                'path' => 'uploads/library/7eytOjuXnRIpkwhPkTjkOPFt79YBv2f3wWsm5vqb.pdf',
                'thumbnail_path' => 'uploads/library/thumbnails/7eytOjuXnRIpkwhPkTjkOPFt79YBv2f3wWsm5vqb.png',
