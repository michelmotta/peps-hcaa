...
class UpdateCertificateRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->app['router']->put('/test-update-certificate', function (UpdateCertificateRequest $request) {
    ...
    public function o_metodo_authorize_impede_o_acesso_a_requisicao(): void
    {
        ...
        $response = $this->putJson('/test-update-certificate');
