                                ...
                                <tbody>
                                    @foreach ($specialties as $specialty)
                                        <tr>
                                            ...
                                            <td>{!! Str::limit(strip_tags($specialty->description), 60) !!}</td>
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $specialty->file->path) }}" data-fancybox>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="confirmDelete('delete-item-{{ $specialty->id }}')" title="Apagar" data-bs-toggle="tooltip">
