        ...
        <div class="bg-primary rounded-3 mt-n6 mx-n4">
            <div class="p-10">
                <h1 class="mb-0 text-white text-center ">
                    ...
                    Comunicado da Aula: {{ $lesson->name }}
                </h1>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">
                            <div class="mt-4">
                                <form method="POST" action="{{ route('dashboard.lessons.messages.update', [$lesson, $message]) }}"
                                    enctype="multipart/form-data">
                                    @method('PATCH')
                                    @include('dashboard.messages.includes.form', ['edit' => true])
                                </form>
                            </div>
                        </div>
                    </div>
