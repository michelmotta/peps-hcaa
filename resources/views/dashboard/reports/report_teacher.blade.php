                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-2 text-center">
                                    <img src="{{ $teacher->getAvatarUrl(150) }}" alt="Foto do Estudante"
                        ...
                        <div class="card-footer bg-white border-top">
                            <div class="row g-3">
                                ...
                                <div class="col-md col-6">
                                    <div class="d-flex align-items-center">
                                        <div class="icon-shape icon-lg bg-light-secondary text-secondary rounded-2 me-3"><i
                                                data-feather="book-open"></i></div>
                                        <div>
                                            <h4 class="mb-0">{{ $stats['created_lessons_count'] }}</h4>
                                            <p class="mb-0 text-muted">Aulas Criadas</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">
                                                {{ $stats['status_counts'][LessonStatusEnum::PUBLICADA->value] ?? 0 }}</h4>
                                ...
                                <div class="col-md col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">
                                                {{ $stats['status_counts'][LessonStatusEnum::RASCUNHO->value] ?? 0 }}</h4>
                                            <p class="mb-0 text-muted">Rascunhos</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md col-12">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">
                                                {{ $stats['status_counts'][LessonStatusEnum::AGUARDANDO_PUBLICACAO->value] ?? 0 }}
                                            </h4>
                                            <p class="mb-0 text-muted">Aguardando</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 text-nowrap table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center py-4 text-muted">Nenhuma aula
                                                    encontrada para este professor no período selecionado.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
